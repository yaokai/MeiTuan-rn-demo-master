                ...
                <View>
                    ...
                    <View style={styles.topContainer}>
                        ...
                        <Button
                            ...
                            onPress={()=>{
                                alert(1);
                                // Bmob.initialize("bd1c1c38a387e9c8b25b7b45024eec51", "3c00ab55b38629bd0442ac933c96d2e5");
                                // Bmob.Sms.requestSmsCode({"mobilePhoneNumber": "15366189892"}).then(function (obj) {
                                //     alert("smsId:" + obj.smsId); //
                                // }, function (err) {
                                //     alert("发送失败:" + err.message+" "+err.code);
                                // });
                            }}
                        />
                    </View>
