...
export function login(name: string,password:string) {
    return 'http://192.168.2.245:8080/login?name='+name+'&password='+password;
}

export function login1(name: string,password:string) {
    return 'http://open.play.cn/api/v2/tv/hall/check_version.json?client_channel=00000000&screenpx=1196*768&apicode=22&version=61104&model=5.1.0&vc=61104&terminal_id=325&channel_code=00000000\n';
}
